...
@section('content')
    <div class="panel">
        <div class="panel-heading">
            <h3 class="panel-title">Rezervasyon Düzenle</h3>
        </div>
        <div class="panel-body container-fluid">
            ...
            <div class="col-md-12">
                ...
                <div class="example-wrap">
                    ...
                    <div class="example">
                        {!! Form::model( $rezervasyon,['method' => 'PATCH', 'action' => ['RezervasyonlarController@update',$rezervasyon->rezervasyonlar_id]]) !!}
                        <div class="form-row">
                            <div class="form-group col-md-4" data-plugin="formMaterial">
                                <label for="tarih" class="">Tarih</label>
                                <input class="form-control " type="date" value="{{ $rezervasyon->rezervasyon_tarihi }}" id="tarih" name="tarih" required>
                            </div>
                        ...
                        <div class="row">
                            <div class="form-group col-lg-8">
                                {!! Form::submit('Rezervasyonu Güncelle' , ['class' => 'btn btn-primary btn-block']) !!}
                            </div>
                        </div>
                        {!!  Form::close() !!}
                    </div>
